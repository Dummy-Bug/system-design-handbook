...
| `02-Operators/` | 0.3 | the 6 operators `& \| ^ ~ << >>` (+ `>>>`) — what each does bit-by-bit | ◑ building — syllabus set, deriving (start `&`) |
| `03-Single-Bit-Ops/` | 0.4–0.8 | test / set / clear / toggle bit `i` from `1<<i`; odd-even | ▢ |
