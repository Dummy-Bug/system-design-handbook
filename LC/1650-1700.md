...
**Tracker:** 6/10 done in 1650-1700 band (all self-derived ACs). Need 7/10 first-try AC for graduation under standard rule, or 7/10 self-derived passes under derivation-over-speed clause (active). Currently on track.
