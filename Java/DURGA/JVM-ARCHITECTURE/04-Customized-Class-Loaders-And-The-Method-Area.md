...
> [!question]- **Deep dive — two objections that make the story sound impossible, and their answers.** Both are worth working through; the mechanism is not obvious. **Objection 1 — undeploying clears memory, so how did anything survive?**
>
