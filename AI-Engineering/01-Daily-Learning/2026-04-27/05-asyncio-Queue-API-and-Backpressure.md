...
Detailed walk-through of each pair lives in its own note — see `06-put-vs-put-nowait.md` for the producer side.
...
>
> **Axis 2 — "wait" vs "nowait":** decides whether the operation can pause the coroutine, or must succeed/fail instantly. (See note 06 for the producer side, and the consumer-side note for `get`.)
>
