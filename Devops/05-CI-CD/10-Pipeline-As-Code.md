...
A Node.js project's repository has a recognisable shape before any of this — a source directory holding the application's own code, a `package.json` describing the project and its dependencies, and a handful of other files at the top level.
