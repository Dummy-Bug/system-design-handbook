...
* Stack overflow has humungous amount of scale but their business logic is straight forward and that's why Monolith wokrs like charm in such cases.
...
*GOOGLE follows [MonoRepo](https://monorepo.tools/) archtecture* 
