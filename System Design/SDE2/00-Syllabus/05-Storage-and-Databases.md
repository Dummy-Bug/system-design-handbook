...
### 3.18 Cursor-based Pagination vs Offset Pagination
...
### 3.21 Distributed Transactions (2PC & Saga)
...
### 3.22 Choosing the Right Database
...
### 3.23 Data Modeling (Schema Design from Requirements)
